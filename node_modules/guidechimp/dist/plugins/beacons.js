  ...
  factory.beacons = function (beacons) {
    ...
    return new ( /*#__PURE__*/function (_Beacons) {
      ...
      (0, _createClass2.default)(_class, [{
        ...
        key: "createBeaconElement",
        value: function createBeaconElement(beacon) {
          var el = (0, _get2.default)((0, _getPrototypeOf2.default)(_class.prototype), "createBeaconElement", this).call(this, beacon);
    ...
    value: function setBeacons(beacons) {
      ...
      if (this.beacons.length) {
        this.beacons.forEach(function (beacon) {
          ...
          var beaconEl = _this2.createBeaconElement(beacon);
